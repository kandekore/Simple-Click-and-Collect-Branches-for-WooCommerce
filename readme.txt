=== Simple Click and Collect Branches for WooCommerce ===
Contributors: darrenkandekore
Tags: woocommerce, click and collect, pickup, collection, branches, locations
...
Manage branches and enable pickup location selection for Click and Collect orders in WooCommerce.
...
This plugin is released under the GPLv2 or later license. See the [LICENSE](https://www.gnu.org/licenses/gpl-2.0.html) file for more details.
